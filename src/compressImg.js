(function(window) {
    ...
    var Orientation = '', //图片方向角
        ...
        imgW = 750; //压缩后的图片的最大宽度，默认是750px，可配置
     ...
     *
     * @param imgWidth,传入函数的图片压缩后的最大图片宽度，默认是750，单位是px，可自由配置。
     *        注意：最好不要超过1000，数字过大，容易导致canvas压缩失败。由于没做切片处理，所以有这个限制。宽度最好不要超过1000
     *        
     */
